...
/**
 * Created by Wire Design Team on 18. Jun 2018.
...
public class WireStyleKit {
    ...
    public static void drawWeek(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezier2Rect.set(42.38f, 10f, 63.5f, 25f);
        Path bezier2Path = CacheForWeek.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(63.5f, 10f);
        bezier2Path.lineTo(59.47f, 25f);
        bezier2Path.lineTo(55.92f, 25f);
        bezier2Path.lineTo(53.03f, 14.2f);
        bezier2Path.lineTo(52.79f, 14.2f);
        bezier2Path.lineTo(49.91f, 25f);
        bezier2Path.lineTo(46.4f, 25f);
        bezier2Path.lineTo(42.38f, 10f);
        bezier2Path.lineTo(45.78f, 10f);
        bezier2Path.lineTo(48.25f, 21.2f);
        bezier2Path.lineTo(48.48f, 21.2f);
        bezier2Path.lineTo(51.34f, 10f);
        bezier2Path.lineTo(54.56f, 10f);
        bezier2Path.lineTo(57.45f, 21.2f);
        bezier2Path.lineTo(57.68f, 21.2f);
        bezier2Path.lineTo(60.14f, 10f);
        bezier2Path.lineTo(63.5f, 10f);
        bezier2Path.close();
    ...
    public static void drawHour(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezier3Rect.set(45f, 4f, 59f, 26f);
        Path bezier3Path = CacheForHour.bezier3Path;
        bezier3Path.reset();
        bezier3Path.moveTo(45f, 26f);
        bezier3Path.lineTo(45f, 4f);
        bezier3Path.lineTo(48.52f, 4f);
        bezier3Path.lineTo(48.52f, 12.7f);
        bezier3Path.lineTo(48.78f, 12.7f);
        bezier3Path.cubicTo(49.53f, 10.92f, 51.22f, 9.84f, 53.57f, 9.84f);
        bezier3Path.cubicTo(56.95f, 9.84f, 59f, 11.99f, 59f, 15.76f);
        bezier3Path.lineTo(59f, 26f);
        bezier3Path.lineTo(55.42f, 26f);
        bezier3Path.lineTo(55.42f, 16.62f);
        bezier3Path.cubicTo(55.42f, 14.21f, 54.32f, 12.98f, 52.25f, 12.98f);
        bezier3Path.cubicTo(49.89f, 12.98f, 48.58f, 14.51f, 48.58f, 16.79f);
        bezier3Path.lineTo(48.58f, 26f);
        bezier3Path.lineTo(45f, 26f);
        bezier3Path.close();
    ...
    public static void drawSecond(Canvas canvas, int color, int color2) {
        WireStyleKit.drawSecond(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit, color, color2);
    }
    
    public static void drawSecond(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color, int color2) {
        // General Declarations
        ...
        bezier2Rect.set(45.53f, 12f, 58f, 27.12f);
        Path bezier2Path = CacheForSecond.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(45.91f, 16.45f);
        bezier2Path.cubicTo(45.91f, 13.82f, 48.32f, 12f, 51.78f, 12f);
        bezier2Path.cubicTo(55.27f, 12f, 57.45f, 13.53f, 57.69f, 16.17f);
        bezier2Path.lineTo(54.57f, 16.17f);
        bezier2Path.cubicTo(54.33f, 15.15f, 53.35f, 14.5f, 51.79f, 14.5f);
        bezier2Path.cubicTo(50.28f, 14.5f, 49.14f, 15.21f, 49.14f, 16.26f);
        bezier2Path.cubicTo(49.14f, 17.09f, 49.84f, 17.59f, 51.31f, 17.93f);
        bezier2Path.lineTo(53.9f, 18.51f);
        bezier2Path.cubicTo(56.7f, 19.13f, 58f, 20.33f, 58f, 22.47f);
        bezier2Path.cubicTo(58f, 25.26f, 55.41f, 27.12f, 51.75f, 27.12f);
        bezier2Path.cubicTo(48.09f, 27.12f, 45.79f, 25.55f, 45.53f, 22.91f);
        bezier2Path.lineTo(48.82f, 22.91f);
        bezier2Path.cubicTo(49.14f, 23.98f, 50.17f, 24.62f, 51.83f, 24.62f);
        bezier2Path.cubicTo(53.51f, 24.62f, 54.68f, 23.89f, 54.68f, 22.81f);
        bezier2Path.cubicTo(54.68f, 21.99f, 54.05f, 21.47f, 52.65f, 21.17f);
        bezier2Path.lineTo(50.05f, 20.57f);
        bezier2Path.cubicTo(47.23f, 19.93f, 45.91f, 18.64f, 45.91f, 16.45f);
        bezier2Path.close();
    ...
    public static void drawMonth(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezierRect.set(41.04f, 7f, 62f, 27f);
        Path bezierPath = CacheForMonth.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(62f, 27f);
        bezierPath.lineTo(58.62f, 27f);
        bezierPath.lineTo(58.62f, 12.93f);
        bezierPath.lineTo(58.43f, 12.93f);
        bezierPath.lineTo(52.82f, 26.22f);
        bezierPath.lineTo(50.23f, 26.22f);
        bezierPath.lineTo(44.62f, 12.93f);
        bezierPath.lineTo(44.42f, 12.93f);
        bezierPath.lineTo(44.42f, 27f);
        bezierPath.lineTo(41.04f, 27f);
        bezierPath.lineTo(41.04f, 7f);
        bezierPath.lineTo(45.29f, 7f);
        bezierPath.lineTo(51.39f, 21.57f);
        bezierPath.lineTo(51.65f, 21.57f);
        bezierPath.lineTo(57.75f, 7f);
        bezierPath.lineTo(62f, 7f);
        bezierPath.lineTo(62f, 27f);
        bezierPath.close();
    ...
    public static void drawMinute(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        // Bezier
        RectF bezierRect = CacheForMinute.bezierRect;
        bezierRect.set(4f, 4f, 60f, 60f);
        Path bezierPath = CacheForMinute.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(32f, 9.09f);
        bezierPath.cubicTo(19.35f, 9.09f, 9.09f, 19.35f, 9.09f, 32f);
        bezierPath.cubicTo(9.09f, 44.65f, 19.35f, 54.91f, 32f, 54.91f);
        ...
        bezier2Rect.set(41.89f, 11f, 63f, 26f);
        Path bezier2Path = CacheForMinute.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(41.89f, 26f);
        bezier2Path.lineTo(41.89f, 11.3f);
        bezier2Path.lineTo(45.12f, 11.3f);
        bezier2Path.lineTo(45.12f, 13.67f);
        bezier2Path.lineTo(45.35f, 13.67f);
        bezier2Path.cubicTo(45.99f, 11.99f, 47.5f, 11f, 49.46f, 11f);
        bezier2Path.cubicTo(51.5f, 11f, 52.92f, 12.02f, 53.54f, 13.67f);
        bezier2Path.lineTo(53.77f, 13.67f);
        bezier2Path.cubicTo(54.5f, 12.06f, 56.2f, 11f, 58.26f, 11f);
        bezier2Path.cubicTo(61.22f, 11f, 63f, 12.84f, 63f, 15.89f);
        bezier2Path.lineTo(63f, 26f);
        bezier2Path.lineTo(59.66f, 26f);
        bezier2Path.lineTo(59.66f, 16.74f);
        bezier2Path.cubicTo(59.66f, 14.84f, 58.76f, 13.9f, 56.96f, 13.9f);
        bezier2Path.cubicTo(55.22f, 13.9f, 54.07f, 15.17f, 54.07f, 16.85f);
        bezier2Path.lineTo(54.07f, 26f);
        bezier2Path.lineTo(50.81f, 26f);
        bezier2Path.lineTo(50.81f, 16.5f);
        bezier2Path.cubicTo(50.81f, 14.88f, 49.78f, 13.9f, 48.13f, 13.9f);
        bezier2Path.cubicTo(46.47f, 13.9f, 45.24f, 15.26f, 45.24f, 17.06f);
        bezier2Path.lineTo(45.24f, 26f);
        bezier2Path.lineTo(41.89f, 26f);
        bezier2Path.close();
    ...
    public static void drawDay(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezier2Rect.set(45.53f, 4f, 60.5f, 26.1f);
        Path bezier2Path = CacheForDay.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(51.96f, 26.1f);
        bezier2Path.cubicTo(48f, 26.1f, 45.53f, 22.96f, 45.53f, 17.95f);
        bezier2Path.cubicTo(45.53f, 12.97f, 48.01f, 9.83f, 51.96f, 9.83f);
        bezier2Path.cubicTo(54.11f, 9.83f, 55.88f, 10.87f, 56.71f, 12.59f);
        bezier2Path.lineTo(56.95f, 12.59f);
        bezier2Path.lineTo(56.95f, 4f);
        bezier2Path.lineTo(60.5f, 4f);
        bezier2Path.lineTo(60.5f, 25.84f);
        bezier2Path.lineTo(57.07f, 25.84f);
        bezier2Path.lineTo(57.07f, 23.35f);
        bezier2Path.lineTo(56.82f, 23.35f);
        bezier2Path.cubicTo(55.94f, 25.07f, 54.14f, 26.1f, 51.96f, 26.1f);
        bezier2Path.close();
        bezier2Path.moveTo(53.06f, 12.87f);
        bezier2Path.cubicTo(50.65f, 12.87f, 49.16f, 14.8f, 49.16f, 17.96f);
        bezier2Path.cubicTo(49.16f, 21.14f, 50.63f, 23.06f, 53.06f, 23.06f);
        bezier2Path.cubicTo(55.51f, 23.06f, 57f, 21.13f, 57f, 17.96f);
        bezier2Path.cubicTo(57f, 14.83f, 55.49f, 12.87f, 53.06f, 12.87f);
        bezier2Path.close();
    ...
    public static void drawYear(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezierRect.set(42.35f, 10f, 58f, 30.33f);
        Path bezierPath = CacheForYear.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(45.48f, 30.33f);
        bezierPath.cubicTo(45.25f, 30.33f, 44.27f, 30.31f, 44.03f, 30.27f);
        bezierPath.lineTo(44.03f, 27.5f);
        bezierPath.cubicTo(44.24f, 27.55f, 44.78f, 27.56f, 45.03f, 27.56f);
        bezierPath.cubicTo(46.58f, 27.56f, 47.45f, 27.01f, 47.92f, 25.64f);
        bezierPath.lineTo(48.11f, 24.98f);
        bezierPath.lineTo(42.35f, 10f);
        bezierPath.lineTo(46.36f, 10f);
        bezierPath.lineTo(50.13f, 21.64f);
        bezierPath.lineTo(50.38f, 21.64f);
        bezierPath.lineTo(54.14f, 10f);
        bezierPath.lineTo(58f, 10f);
        bezierPath.lineTo(52.18f, 25.39f);
        bezierPath.cubicTo(50.81f, 29.1f, 49.09f, 30.33f, 45.48f, 30.33f);
        bezierPath.close();
    ...
    public static void drawBusyIcon(Canvas canvas) {
        WireStyleKit.drawBusyIcon(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit);
    }
    
    public static void drawBusyIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        // General Declarations
        Paint paint = CacheForBusyIcon.paint;
        
        // Local Colors
        int fillColor9 = Color.argb(255, 0, 0, 0);
    ...
    private static Bitmap imageOfBusyIcon = null;
    public static Bitmap imageOfBusyIcon() {
        if (imageOfBusyIcon != null)
            return imageOfBusyIcon;
        
        imageOfBusyIcon = Bitmap.createBitmap(64, 64, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(imageOfBusyIcon);
        WireStyleKit.drawBusyIcon(canvas);
