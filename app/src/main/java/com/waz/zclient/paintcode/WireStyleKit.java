...
/**
 * Created by Wire Design Team on 14. Jun 2018.
...
public class WireStyleKit {
    ...
    public static void drawHour(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezier3Rect.set(48.12f, 4.87f, 60.05f, 25f);
        Path bezier3Path = CacheForHour.bezier3Path;
        bezier3Path.reset();
        bezier3Path.moveTo(48.12f, 25f);
        bezier3Path.lineTo(48.12f, 4.87f);
        bezier3Path.lineTo(50.42f, 4.87f);
        bezier3Path.lineTo(50.42f, 12.86f);
        bezier3Path.lineTo(50.63f, 12.86f);
        bezier3Path.cubicTo(51.36f, 11.27f, 52.87f, 10.34f, 55.07f, 10.34f);
        bezier3Path.cubicTo(58.12f, 10.34f, 60.05f, 12.29f, 60.05f, 15.67f);
        bezier3Path.lineTo(60.05f, 25f);
        bezier3Path.lineTo(57.75f, 25f);
        bezier3Path.lineTo(57.75f, 16.23f);
        bezier3Path.cubicTo(57.75f, 13.68f, 56.6f, 12.41f, 54.42f, 12.41f);
        bezier3Path.cubicTo(51.84f, 12.41f, 50.42f, 14.04f, 50.42f, 16.47f);
        bezier3Path.lineTo(50.42f, 25f);
        bezier3Path.lineTo(48.12f, 25f);
        bezier3Path.close();
        ...
        // Bezier 2
        RectF bezier2Rect = CacheForHour.bezier2Rect;
        bezier2Rect.set(5f, 5f, 59f, 59f);
        Path bezier2Path = CacheForHour.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(43.35f, 9.68f);
        bezier2Path.cubicTo(39.94f, 7.94f, 36.08f, 6.96f, 32f, 6.96f);
        bezier2Path.cubicTo(18.17f, 6.96f, 6.96f, 18.17f, 6.96f, 32f);
        bezier2Path.cubicTo(6.96f, 45.83f, 18.17f, 57.04f, 32f, 57.04f);
        bezier2Path.cubicTo(45.83f, 57.04f, 57.04f, 45.83f, 57.04f, 32f);
        bezier2Path.cubicTo(57.04f, 31.3f, 57.01f, 30.6f, 56.95f, 29.91f);
        bezier2Path.cubicTo(57.64f, 29.85f, 58.3f, 29.79f, 58.91f, 29.73f);
        bezier2Path.cubicTo(58.97f, 30.48f, 59f, 31.23f, 59f, 32f);
        bezier2Path.cubicTo(59f, 46.91f, 46.91f, 59f, 32f, 59f);
        bezier2Path.cubicTo(17.09f, 59f, 5f, 46.91f, 5f, 32f);
        bezier2Path.cubicTo(5f, 17.09f, 17.09f, 5f, 32f, 5f);
        bezier2Path.cubicTo(36.42f, 5f, 40.59f, 6.06f, 44.27f, 7.94f);
        bezier2Path.cubicTo(44f, 8.44f, 43.69f, 9.02f, 43.35f, 9.68f);
        bezier2Path.close();
    ...
    public static void drawMinute(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezier3Rect.set(43.99f, 11.34f, 63.61f, 26f);
        Path bezier3Path = CacheForMinute.bezier3Path;
        bezier3Path.reset();
        bezier3Path.moveTo(43.99f, 26f);
        bezier3Path.lineTo(43.99f, 11.59f);
        bezier3Path.lineTo(46.18f, 11.59f);
        bezier3Path.lineTo(46.18f, 13.86f);
        bezier3Path.lineTo(46.39f, 13.86f);
        bezier3Path.cubicTo(47.05f, 12.26f, 48.49f, 11.34f, 50.42f, 11.34f);
        bezier3Path.cubicTo(52.37f, 11.34f, 53.73f, 12.36f, 54.4f, 13.86f);
        bezier3Path.lineTo(54.62f, 13.86f);
        bezier3Path.cubicTo(55.39f, 12.34f, 57.04f, 11.34f, 59.03f, 11.34f);
        bezier3Path.cubicTo(61.97f, 11.34f, 63.61f, 13.02f, 63.61f, 16.04f);
        bezier3Path.lineTo(63.61f, 26f);
        bezier3Path.lineTo(61.31f, 26f);
        bezier3Path.lineTo(61.31f, 16.58f);
        bezier3Path.cubicTo(61.31f, 14.45f, 60.31f, 13.41f, 58.28f, 13.41f);
        bezier3Path.cubicTo(56.27f, 13.41f, 54.94f, 14.9f, 54.94f, 16.74f);
        bezier3Path.lineTo(54.94f, 26f);
        bezier3Path.lineTo(52.64f, 26f);
        bezier3Path.lineTo(52.64f, 16.21f);
        bezier3Path.cubicTo(52.64f, 14.5f, 51.45f, 13.41f, 49.63f, 13.41f);
        bezier3Path.cubicTo(47.74f, 13.41f, 46.29f, 15.04f, 46.29f, 17.07f);
        bezier3Path.lineTo(46.29f, 26f);
        bezier3Path.lineTo(43.99f, 26f);
        bezier3Path.close();
    ...
    public static void drawDay(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        // Bezier 3
        RectF bezier3Rect = CacheForDay.bezier3Rect;
        bezier3Rect.set(46.27f, 4.87f, 59.34f, 25.25f);
        Path bezier3Path = CacheForDay.bezier3Path;
        bezier3Path.reset();
        bezier3Path.moveTo(52.32f, 25.25f);
        bezier3Path.cubicTo(48.63f, 25.25f, 46.27f, 22.33f, 46.27f, 17.79f);
        bezier3Path.cubicTo(46.27f, 13.28f, 48.66f, 10.34f, 52.32f, 10.34f);
        bezier3Path.cubicTo(54.33f, 10.34f, 56.02f, 11.28f, 56.84f, 12.86f);
        bezier3Path.lineTo(57.04f, 12.86f);
        bezier3Path.lineTo(57.04f, 4.87f);
        bezier3Path.lineTo(59.34f, 4.87f);
        bezier3Path.lineTo(59.34f, 25f);
        bezier3Path.lineTo(57.15f, 25f);
        bezier3Path.lineTo(57.15f, 22.7f);
        bezier3Path.lineTo(56.93f, 22.7f);
        bezier3Path.cubicTo(56.02f, 24.3f, 54.31f, 25.25f, 52.32f, 25.25f);
        bezier3Path.close();
        bezier3Path.moveTo(52.86f, 12.41f);
        bezier3Path.cubicTo(50.24f, 12.41f, 48.65f, 14.44f, 48.65f, 17.79f);
        bezier3Path.cubicTo(48.65f, 21.16f, 50.22f, 23.18f, 52.86f, 23.18f);
        bezier3Path.cubicTo(55.48f, 23.18f, 57.09f, 21.12f, 57.09f, 17.79f);
        bezier3Path.cubicTo(57.09f, 14.49f, 55.46f, 12.41f, 52.86f, 12.41f);
        bezier3Path.close();
    ...
    public static void drawWeek(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        // Clip
        RectF clipRect = CacheForWeek.clipRect;
        clipRect.set(44.9f, 11.79f, 64.01f, 26f);
        Path clipPath = CacheForWeek.clipPath;
        clipPath.reset();
        clipPath.moveTo(64.01f, 11.79f);
        clipPath.lineTo(60.03f, 26f);
        clipPath.lineTo(57.72f, 26f);
        clipPath.lineTo(54.55f, 15f);
        clipPath.lineTo(54.34f, 15f);
        clipPath.lineTo(51.17f, 26f);
        clipPath.lineTo(48.88f, 26f);
        clipPath.lineTo(44.9f, 11.79f);
        clipPath.lineTo(47.19f, 11.79f);
        clipPath.lineTo(49.99f, 23.15f);
        clipPath.lineTo(50.2f, 23.15f);
        clipPath.lineTo(53.37f, 11.79f);
        clipPath.lineTo(55.55f, 11.79f);
        clipPath.lineTo(58.73f, 23.15f);
        clipPath.lineTo(58.94f, 23.15f);
        clipPath.lineTo(61.73f, 11.79f);
        clipPath.lineTo(64.01f, 11.79f);
        clipPath.close();
        ...
        // Bezier 3
        RectF bezier3Rect = CacheForWeek.bezier3Rect;
        bezier3Rect.set(5f, 5f, 59f, 59f);
        Path bezier3Path = CacheForWeek.bezier3Path;
        bezier3Path.reset();
        bezier3Path.moveTo(43.35f, 9.68f);
        bezier3Path.cubicTo(39.94f, 7.94f, 36.08f, 6.96f, 32f, 6.96f);
        bezier3Path.cubicTo(18.17f, 6.96f, 6.96f, 18.17f, 6.96f, 32f);
        bezier3Path.cubicTo(6.96f, 45.83f, 18.17f, 57.04f, 32f, 57.04f);
        bezier3Path.cubicTo(45.83f, 57.04f, 57.04f, 45.83f, 57.04f, 32f);
        bezier3Path.cubicTo(57.04f, 31.3f, 57.01f, 30.6f, 56.95f, 29.91f);
        bezier3Path.cubicTo(57.64f, 29.85f, 58.3f, 29.79f, 58.91f, 29.73f);
        bezier3Path.cubicTo(58.97f, 30.48f, 59f, 31.23f, 59f, 32f);
        bezier3Path.cubicTo(59f, 46.91f, 46.91f, 59f, 32f, 59f);
        bezier3Path.cubicTo(17.09f, 59f, 5f, 46.91f, 5f, 32f);
        bezier3Path.cubicTo(5f, 17.09f, 17.09f, 5f, 32f, 5f);
        bezier3Path.cubicTo(36.42f, 5f, 40.59f, 6.06f, 44.27f, 7.94f);
        bezier3Path.cubicTo(44f, 8.44f, 43.69f, 9.02f, 43.35f, 9.68f);
        bezier3Path.close();
    ...
    public static void drawSecond(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezier2Rect.set(47.27f, 10.34f, 58.71f, 25.25f);
        Path bezier2Path = CacheForSecond.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(47.65f, 14.53f);
        bezier2Path.cubicTo(47.65f, 12.14f, 49.97f, 10.34f, 53.03f, 10.34f);
        bezier2Path.cubicTo(56.05f, 10.34f, 58.15f, 11.83f, 58.46f, 14.2f);
        bezier2Path.lineTo(56.18f, 14.2f);
        bezier2Path.cubicTo(55.88f, 13.05f, 54.75f, 12.29f, 53.01f, 12.29f);
        bezier2Path.cubicTo(51.3f, 12.29f, 49.97f, 13.16f, 49.97f, 14.44f);
        bezier2Path.cubicTo(49.97f, 15.43f, 50.77f, 16.04f, 52.47f, 16.46f);
        bezier2Path.lineTo(54.69f, 16.99f);
        bezier2Path.cubicTo(57.4f, 17.65f, 58.71f, 18.82f, 58.71f, 20.9f);
        bezier2Path.cubicTo(58.71f, 23.48f, 56.21f, 25.25f, 52.93f, 25.25f);
        bezier2Path.cubicTo(49.73f, 25.25f, 47.52f, 23.72f, 47.27f, 21.32f);
        bezier2Path.lineTo(49.63f, 21.32f);
        bezier2Path.cubicTo(50.02f, 22.54f, 51.17f, 23.32f, 53.01f, 23.32f);
        bezier2Path.cubicTo(54.95f, 23.32f, 56.34f, 22.39f, 56.34f, 21.07f);
        bezier2Path.cubicTo(56.34f, 20.08f, 55.59f, 19.41f, 54.06f, 19.04f);
        bezier2Path.lineTo(51.58f, 18.44f);
        bezier2Path.cubicTo(48.88f, 17.78f, 47.65f, 16.62f, 47.65f, 14.53f);
        bezier2Path.close();
        ...
        // Bezier 3
        RectF bezier3Rect = CacheForSecond.bezier3Rect;
        bezier3Rect.set(5f, 5f, 59f, 59f);
        Path bezier3Path = CacheForSecond.bezier3Path;
        bezier3Path.reset();
        bezier3Path.moveTo(43.35f, 9.68f);
        bezier3Path.cubicTo(39.94f, 7.94f, 36.08f, 6.96f, 32f, 6.96f);
        bezier3Path.cubicTo(18.17f, 6.96f, 6.96f, 18.17f, 6.96f, 32f);
