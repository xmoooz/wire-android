...
/**
 * Created by Wire Design Team on 22. Jun 2018.
...
public class WireStyleKit {
    ...
    private static class CacheForTimedMessages {
        ...
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
        private static RectF timedRect = new RectF();
        private static Path timedPath = new Path();
    }
    ...
    public static void drawTimedMessages(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        // Timed
        RectF timedRect = CacheForTimedMessages.timedRect;
        timedRect.set(8f, 0f, 56f, 64f);
        Path timedPath = CacheForTimedMessages.timedPath;
        timedPath.reset();
        timedPath.moveTo(28f, 32f);
        timedPath.cubicTo(28f, 34.21f, 29.79f, 36f, 32f, 36f);
        timedPath.cubicTo(34.21f, 36f, 36f, 34.21f, 36f, 32f);
        timedPath.lineTo(28f, 32f);
        timedPath.close();
        timedPath.moveTo(36f, 32f);
        timedPath.cubicTo(36f, 36.02f, 37.46f, 38.58f, 40.45f, 41.21f);
        timedPath.cubicTo(40.69f, 41.4f, 42.7f, 43.12f, 43.21f, 43.62f);
        timedPath.cubicTo(45.86f, 46.19f, 47.41f, 49.68f, 47.86f, 56f);
        timedPath.lineTo(16.14f, 56f);
        timedPath.cubicTo(16.59f, 49.68f, 18.14f, 46.19f, 20.79f, 43.62f);
        timedPath.cubicTo(21.3f, 43.12f, 23.31f, 41.4f, 23.55f, 41.21f);
        timedPath.cubicTo(26.54f, 38.58f, 28f, 36.02f, 28f, 32f);
        timedPath.lineTo(36f, 32f);
        timedPath.close();
        timedPath.moveTo(47.86f, 8f);
        timedPath.cubicTo(47.75f, 9.48f, 47.6f, 10.81f, 47.37f, 12f);
        timedPath.lineTo(16.63f, 12f);
        timedPath.cubicTo(16.4f, 10.81f, 16.25f, 9.48f, 16.14f, 8f);
        timedPath.lineTo(47.86f, 8f);
        timedPath.close();
        timedPath.moveTo(51.87f, 8f);
        timedPath.lineTo(56f, 8f);
        timedPath.lineTo(56f, 4f);
        timedPath.cubicTo(56f, 1.78f, 54.2f, 0f, 51.99f, 0f);
        timedPath.lineTo(12.01f, 0f);
        timedPath.cubicTo(9.82f, 0f, 8f, 1.79f, 8f, 4f);
        timedPath.lineTo(8f, 8f);
        timedPath.lineTo(12.13f, 8f);
        timedPath.cubicTo(13.44f, 26.81f, 24f, 23.24f, 24f, 32f);
        timedPath.cubicTo(24f, 40.76f, 13.44f, 37.19f, 12.13f, 56f);
        timedPath.lineTo(12.13f, 56f);
        timedPath.lineTo(8f, 56f);
        timedPath.lineTo(8f, 60f);
        timedPath.cubicTo(8f, 62.22f, 9.8f, 64f, 12.01f, 64f);
        timedPath.lineTo(51.99f, 64f);
        timedPath.cubicTo(54.18f, 64f, 56f, 62.21f, 56f, 60f);
        timedPath.lineTo(56f, 56f);
        timedPath.lineTo(51.87f, 56f);
        timedPath.lineTo(51.87f, 56f);
        timedPath.cubicTo(50.56f, 37.19f, 40f, 40.76f, 40f, 32f);
        timedPath.cubicTo(40f, 23.24f, 50.56f, 26.81f, 51.87f, 8f);
        timedPath.lineTo(51.87f, 8f);
        timedPath.close();
        
        paint.reset();
        paint.setFlags(Paint.ANTI_ALIAS_FLAG);
        timedPath.setFillType(Path.FillType.EVEN_ODD);
        paint.setStyle(Paint.Style.FILL);
        paint.setColor(color);
        canvas.drawPath(timedPath, paint);
