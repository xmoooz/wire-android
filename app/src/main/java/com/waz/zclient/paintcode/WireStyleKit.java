...
/**
 * Created by Wire Design Team on 26. Oct 2018.
...
public class WireStyleKit {
    ...
    public static void drawArchive(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        bezierPath.reset();
        bezierPath.moveTo(0f, 20f);
        bezierPath.lineTo(0f, 36f);
        bezierPath.lineTo(64f, 36f);
        bezierPath.lineTo(64f, 20f);
        bezierPath.lineTo(40f, 20f);
        bezierPath.lineTo(40f, 28f);
        bezierPath.lineTo(24f, 28f);
        bezierPath.lineTo(24f, 20f);
        bezierPath.lineTo(0f, 20f);
        bezierPath.close();
        bezierPath.moveTo(0f, 44f);
        bezierPath.lineTo(0f, 60f);
        bezierPath.lineTo(64f, 60f);
        bezierPath.lineTo(64f, 44f);
        bezierPath.lineTo(40f, 44f);
        bezierPath.lineTo(40f, 52f);
        bezierPath.lineTo(24f, 52f);
        bezierPath.lineTo(24f, 44f);
        bezierPath.lineTo(0f, 44f);
        bezierPath.close();
        bezierPath.moveTo(64f, 4f);
        bezierPath.lineTo(64f, 12f);
        bezierPath.lineTo(0f, 12f);
        bezierPath.lineTo(0f, 4f);
        bezierPath.lineTo(64f, 4f);
        bezierPath.close();
